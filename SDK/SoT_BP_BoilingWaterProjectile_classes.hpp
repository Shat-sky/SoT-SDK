...
{
public:
	class UStaticMeshComponent*                        Sphere;                                                   // 0x0728(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USphereComponent*                            Collision;                                                // 0x0730(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
#include "SoT_BP_Anim_OceanCrawler_Hermit_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_Anim_OceanCrawler_Hermit.BP_Anim_OceanCrawler_Hermit_C"));
		return ptr;
	}

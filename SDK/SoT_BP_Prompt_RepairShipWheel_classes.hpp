...
#include "SoT_BP_Prompt_RepairShipWheel_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Prompt_RepairShipWheel.BP_Prompt_RepairShipWheel_C"));
		return ptr;
	}

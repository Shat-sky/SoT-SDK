...
{
public:
	class UStaticMeshComponent*                        shp_fry_pan_01_a1;                                        // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_fry_pan_01_a;                                         // 0x0400(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        cmn_cooking__pot_011;                                     // 0x0408(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        cmn_cooking__pot_01;                                      // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        cmn_fishing_cooker_lid_01_a;                              // 0x0418(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

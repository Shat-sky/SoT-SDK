...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass GHLetter_ExclusionEntitlement_Campaign018.GHLetter_ExclusionEntitlement_Campaign018_C");
		return ptr;
	}

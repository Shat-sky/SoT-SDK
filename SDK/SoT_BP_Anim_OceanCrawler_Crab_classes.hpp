...
#include "SoT_BP_Anim_OceanCrawler_Crab_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_Anim_OceanCrawler_Crab.BP_Anim_OceanCrawler_Crab_C"));
		return ptr;
	}

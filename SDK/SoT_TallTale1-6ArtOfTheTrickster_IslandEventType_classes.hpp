...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TallTale1-6ArtOfTheTrickster_IslandEventType.TallTale1-6ArtOfTheTrickster_IslandEventType_C"));
		return ptr;
	}

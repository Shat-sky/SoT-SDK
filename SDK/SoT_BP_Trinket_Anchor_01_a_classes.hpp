...
{
public:
	class UStaticMeshComponent*                        shp_int_hook_01_a;                                        // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_anchor_02_a;                                          // 0x0400(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_int_hook_01_a1;                                       // 0x0408(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

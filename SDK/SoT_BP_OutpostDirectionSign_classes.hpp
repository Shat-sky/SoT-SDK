...
#include "SoT_BP_OutpostDirectionSign_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_OutpostDirectionSign.BP_OutpostDirectionSign_C"));
		return ptr;
	}

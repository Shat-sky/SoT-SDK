...
{
public:
	class UEmissaryMaxRankQuestProvider*               EmissaryMaxRankQuestProvider;                             // 0x06A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_LegendaryTavern.BP_LegendaryTavern_C");
		return ptr;
	}

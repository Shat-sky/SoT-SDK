...
public:
	...
	class UChildActorComponent*                        MiddleRightSeat;                                          // 0x0A18(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        MiddleLeftSeat;                                           // 0x0A20(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

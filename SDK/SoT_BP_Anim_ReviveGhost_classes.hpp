...
#include "SoT_BP_Anim_ReviveGhost_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_Anim_ReviveGhost.BP_Anim_ReviveGhost_C"));
		return ptr;
	}

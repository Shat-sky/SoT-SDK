...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PlantForm_AnimNotifyEmitterComponent.BP_PlantForm_AnimNotifyEmitterComponent_C"));
		return ptr;
	}

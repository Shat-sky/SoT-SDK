...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_HauntedShores_BanisherOfTheSpectralFlame.Title_HauntedShores_BanisherOfTheSpectralFlame_C");
		return ptr;
	}

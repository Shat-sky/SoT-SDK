...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_BoomBones_LegendarySkeletonExploder.Title_BoomBones_LegendarySkeletonExploder_C");
		return ptr;
	}

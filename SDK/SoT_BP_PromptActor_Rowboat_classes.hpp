...
public:
	...
	class UBP_Prompt_MaidenVoyage_RowboatTutorial_C*   PromptCoordinator;                                        // 0x0408(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

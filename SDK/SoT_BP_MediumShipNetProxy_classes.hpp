...
public:
	...
	TArray<class UMaterialInstanceDynamic*>            Dynamic_Materials;                                        // 0x04C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MediumShipNetProxy.BP_MediumShipNetProxy_C");
		return ptr;
	}

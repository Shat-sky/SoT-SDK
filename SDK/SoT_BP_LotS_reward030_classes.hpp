...
#include "SoT_BP_LotS_reward030_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_LotS_reward030.BP_LotS_reward030_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass NoGunpowderAmbientGoldHoarderCastawaySpawnContext.NoGunpowderAmbientGoldHoarderCastawaySpawnContext_C");
		return ptr;
	}

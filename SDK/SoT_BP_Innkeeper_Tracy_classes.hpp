...
public:
	...
	class UWwiseEvent*                                 SFX_IdleLoopPlay_1;                                       // 0x0650(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UWwiseEvent*                                 SFX_IdleLoopStop_1;                                       // 0x0658(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FWwiseEmitter                               InnkeeperEmitter_1;                                       // 0x0660(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)

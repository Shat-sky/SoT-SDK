...
#include "SoT_BP_TaleBook_SunkenCrystal_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TaleBook_SunkenCrystal.BP_TaleBook_SunkenCrystal_C"));
		return ptr;
	}

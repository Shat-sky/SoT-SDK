...
#include "SoT_BP_Prompt_EmissarySunk_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Prompt_EmissarySunk.BP_Prompt_EmissarySunk_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass TallTale1-8RevengeOfTheMorningstar_IslandEventType.TallTale1-8RevengeOfTheMorningstar_IslandEventType_C");
		return ptr;
	}

...
#include "SoT_BP_LotS_reward038_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_LotS_reward038.BP_LotS_reward038_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_CursedSails_ProtectorOfTheShoresOfPlenty.Title_CursedSails_ProtectorOfTheShoresOfPlenty_C");
		return ptr;
	}

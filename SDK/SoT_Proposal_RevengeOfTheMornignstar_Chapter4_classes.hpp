...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Proposal_RevengeOfTheMornignstar_Chapter4.Proposal_RevengeOfTheMornignstar_Chapter4_C");
		return ptr;
	}

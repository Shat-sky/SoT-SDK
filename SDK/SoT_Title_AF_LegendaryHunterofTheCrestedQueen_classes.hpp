...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Title_AF_LegendaryHunterofTheCrestedQueen.Title_AF_LegendaryHunterofTheCrestedQueen_C"));
		return ptr;
	}

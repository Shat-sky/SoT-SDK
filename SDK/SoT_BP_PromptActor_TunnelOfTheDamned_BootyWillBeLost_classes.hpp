...
public:
	...
	class UBP_Prompt_TunnelOfTheDamned_BootyWillBeLost_C* PromptCoordinator;                                        // 0x0408(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

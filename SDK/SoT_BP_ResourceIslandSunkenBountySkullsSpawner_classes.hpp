...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ResourceIslandSunkenBountySkullsSpawner.BP_ResourceIslandSunkenBountySkullsSpawner_C"));
		return ptr;
	}

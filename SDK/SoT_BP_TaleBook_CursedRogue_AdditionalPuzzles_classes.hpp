...
#include "SoT_BP_TaleBook_CursedRogue_AdditionalPuzzles_structs.hpp"
...
// BlueprintGeneratedClass BP_TaleBook_CursedRogue_AdditionalPuzzles.BP_TaleBook_CursedRogue_AdditionalPuzzles_C
// 0x0030 (0x0750 - 0x0720)
class ABP_TaleBook_CursedRogue_AdditionalPuzzles_C : public AVoyageProposalContainer
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TaleBook_CursedRogue_AdditionalPuzzles.BP_TaleBook_CursedRogue_AdditionalPuzzles_C"));
		return ptr;
	}

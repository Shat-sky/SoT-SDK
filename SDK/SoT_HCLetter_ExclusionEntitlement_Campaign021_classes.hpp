...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass HCLetter_ExclusionEntitlement_Campaign021.HCLetter_ExclusionEntitlement_Campaign021_C");
		return ptr;
	}

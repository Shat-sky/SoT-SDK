...
public:
	...
	class UChildActorComponent*                        BP_ShipFlagCustomizationChest;                            // 0x0A88(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        BP_Bell;                                                  // 0x0A90(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_flag_jolly_roger_01_a;                                // 0x0A98(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

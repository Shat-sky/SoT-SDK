...
#include "SoT_BP_PromptActor_EmissarySoldLoot_MA_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_EmissarySoldLoot_MA.BP_PromptActor_EmissarySoldLoot_MA_C"));
		return ptr;
	}

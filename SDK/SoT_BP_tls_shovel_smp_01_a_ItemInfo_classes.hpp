...
#include "SoT_BP_tls_shovel_smp_01_a_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_tls_shovel_smp_01_a_ItemInfo.BP_tls_shovel_smp_01_a_ItemInfo_C"));
		return ptr;
	}

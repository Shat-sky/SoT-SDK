...
// Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.WaitForRotatingCompassDestroyed
// (Final, RequiredAPI, Native, Public)
// Parameters:
// class AActor*                  InRotatingCompass              (Parm, ZeroConstructor, IsPlainOldData)

void UTaleQuestRotatingCompassFunctionLibrary::WaitForRotatingCompassDestroyed(class AActor* InRotatingCompass)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.WaitForRotatingCompassDestroyed"));
...
// Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.UpdateRotatingCompassSplinePath
// (Final, RequiredAPI, Native, Public)
// Parameters:
// class AActor*                  InRotatingCompass              (Parm, ZeroConstructor, IsPlainOldData)

void UTaleQuestRotatingCompassFunctionLibrary::UpdateRotatingCompassSplinePath(class AActor* InRotatingCompass)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EnchantedCompass.TaleQuestRotatingCompassFunctionLibrary.UpdateRotatingCompassSplinePath"));

...
{
public:
	class UStaticMeshComponent*                        gmp_pl_cabin_dogBowl_a_02;                                // 0x0408(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        cmn_clay_dish_01_b;                                       // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
#include "SoT_BP_Audio_Play_sfx_shrouded_island_ambience_structs.hpp"
...
// BlueprintGeneratedClass BP_Audio_Play_sfx_shrouded_island_ambience.BP_Audio_Play_sfx_shrouded_island_ambience_C
// 0x0048 (0x0410 - 0x03C8)
class ABP_Audio_Play_sfx_shrouded_island_ambience_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Audio_Play_sfx_shrouded_island_ambience.BP_Audio_Play_sfx_shrouded_island_ambience_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Audio_Play_sfx_shrouded_island_ambience(int EntryPoint);
};

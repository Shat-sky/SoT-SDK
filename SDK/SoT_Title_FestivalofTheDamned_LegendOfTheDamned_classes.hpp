...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Title_FestivalofTheDamned_LegendOfTheDamned.Title_FestivalofTheDamned_LegendOfTheDamned_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MaidenVoyage_DoubloonsInHold_Entitlement.BP_MaidenVoyage_DoubloonsInHold_Entitlement_C");
		return ptr;
	}

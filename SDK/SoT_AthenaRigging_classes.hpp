...
public:
	...
	class UInstancedRopeComponent*                     InstancedRopes;                                           // 0x0420(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<struct FRiggingSystemLine>                  Lines;                                                    // 0x0428(0x0010) (ZeroConstructor)
	TArray<struct FInstancedRopeParams>                Ropes;                                                    // 0x0438(0x0010) (ZeroConstructor)
	TArray<class UMobileInstancedStaticMeshComponent*> PulleyInstances;                                          // 0x0448(0x0010) (ExportObject, ZeroConstructor)
	struct FRiggingSystemPulleyData                    Pulleys;                                                  // 0x0458(0x0060)
	TArray<struct FSocketId>                           Sockets;                                                  // 0x04B8(0x0010) (ZeroConstructor)
	TArray<float>                                      InitialMainRopeLengths;                                   // 0x04C8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x88];                                      // 0x04D8(0x0088) MISSED OFFSET
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("Class AthenaRigging.RopeCatenaryRenderComponent");
		return ptr;
	}

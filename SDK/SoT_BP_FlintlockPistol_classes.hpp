...
public:
	...
	class UPostProcessComponent*                       PostProcess;                                              // 0x0A58(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UMaterialInstanceDynamic*                    DynamicMaterial;                                          // 0x0A68(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UObject*                                     ThirdPerson_VFX_AI;                                       // 0x0A70(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UWwiseEvent*                                 Flintlock3rdPersonSFX;                                    // 0x0A78(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UWwiseEvent*                                 FlintLockFirstPersonSFX;                                  // 0x0A80(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Proposal_RevengeOfTheMornignstar_Chapter2.Proposal_RevengeOfTheMornignstar_Chapter2_C");
		return ptr;
	}

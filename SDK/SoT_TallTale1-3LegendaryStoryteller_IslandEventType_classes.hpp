...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass TallTale1-3LegendaryStoryteller_IslandEventType.TallTale1-3LegendaryStoryteller_IslandEventType_C");
		return ptr;
	}

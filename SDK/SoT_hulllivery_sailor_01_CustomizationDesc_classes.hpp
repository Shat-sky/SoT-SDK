...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass hulllivery_sailor_01_CustomizationDesc.hulllivery_sailor_01_CustomizationDesc_C"));
		return ptr;
	}

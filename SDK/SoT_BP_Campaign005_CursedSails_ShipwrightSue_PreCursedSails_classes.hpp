...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Campaign005_CursedSails_ShipwrightSue_PreCursedSails.BP_Campaign005_CursedSails_ShipwrightSue_PreCursedSails_C"));
		return ptr;
	}

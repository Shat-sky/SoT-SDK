...
class ABP_SkellyFort_SkullCloud_C : public AGameplayEventSignal_StaticMesh
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_SkellyFort_SkullCloud.BP_SkellyFort_SkullCloud_C");
		return ptr;
	}

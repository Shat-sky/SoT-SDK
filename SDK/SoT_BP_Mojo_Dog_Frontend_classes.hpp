...
#include "SoT_BP_Mojo_Dog_Frontend_structs.hpp"
...
// BlueprintGeneratedClass BP_Mojo_Dog_Frontend.BP_Mojo_Dog_Frontend_C
// 0x0018 (0x03E0 - 0x03C8)
class ABP_Mojo_Dog_Frontend_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Mojo_Dog_Frontend.BP_Mojo_Dog_Frontend_C"));
		return ptr;
	}

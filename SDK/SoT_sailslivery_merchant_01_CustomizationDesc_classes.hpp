...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass sailslivery_merchant_01_CustomizationDesc.sailslivery_merchant_01_CustomizationDesc_C");
		return ptr;
	}

...
public:
	...
	struct FName                                       PropAttachmentSocket;                                     // 0x0458(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TArray<class UClass*>                              StrategiesForAggressiveAnimations;                        // 0x05A0(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	struct FFloatRange                                 TimeBeforeAlternativeAggressiveAnimationToggleFlips;      // 0x05B0(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

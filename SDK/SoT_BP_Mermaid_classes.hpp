...
public:
	...
	class UAnimNotifyWwiseEmitterComponent*            AnimNotifyWwiseEmitter;                                   // 0x09C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USkeletalMeshMemoryConstraintComponent*      SkeletalMeshMemoryConstraint;                             // 0x09C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

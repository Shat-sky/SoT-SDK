...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass sailslivery_highwayman_01_CustomizationDesc.sailslivery_highwayman_01_CustomizationDesc_C"));
		return ptr;
	}

...
{
public:
	class UStaticMeshComponent*                        tri_com_gmp_onboarding_map_static_01_a;                   // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        cmn_picture_frame_02_a;                                   // 0x0400(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
public:
	...
	class UCommodityRedemptionComponent*               CommodityRedemption;                                      // 0x0690(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UEmissaryMaxRankQuestProvider*               EmissaryMaxRankQuestProvider;                             // 0x0698(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UNPCDialogComponent*                         NPCDialogSellCrate;                                       // 0x06B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UNPCDialogComponent*                         NPCDialog;                                                // 0x06B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMerchantCrateProviderComponent*             MerchantCrateProvider;                                    // 0x06C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USkeletalMeshComponent*                      cmp_pocket_watch_mrh_01_e;                                // 0x06C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
#include "SoT_BP_Prompt_EmissaryStoleLoot_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Prompt_EmissaryStoleLoot.BP_Prompt_EmissaryStoleLoot_C"));
		return ptr;
	}

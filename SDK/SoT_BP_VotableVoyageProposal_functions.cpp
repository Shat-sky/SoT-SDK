...
// Function BP_VotableVoyageProposal.BP_VotableVoyageProposal_C.GetVoteCount
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            Count                          (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABP_VotableVoyageProposal_C::GetVoteCount(int* Count)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_VotableVoyageProposal.BP_VotableVoyageProposal_C.GetVoteCount"));

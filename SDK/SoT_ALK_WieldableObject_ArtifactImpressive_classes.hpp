...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ALK_WieldableObject_ArtifactImpressive.ALK_WieldableObject_ArtifactImpressive_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass flag_Alliance_Leave_01_CustomizationDesc.flag_Alliance_Leave_01_CustomizationDesc_C"));
		return ptr;
	}

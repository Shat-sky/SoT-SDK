...
public:
	...
	class UDecalComponent*                             DirtDecal;                                                // 0x0440(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        DirtPile;                                                 // 0x0448(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

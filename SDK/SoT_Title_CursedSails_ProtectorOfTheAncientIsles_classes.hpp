...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_CursedSails_ProtectorOfTheAncientIsles.Title_CursedSails_ProtectorOfTheAncientIsles_C");
		return ptr;
	}

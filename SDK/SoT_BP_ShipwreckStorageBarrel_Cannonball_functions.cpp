...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwreckStorageBarrel_Cannonball.BP_ShipwreckStorageBarrel_Cannonball_C.UserConstructionScript"));

...
#include "SoT_BP_FactionOutpostVote_PirateLord_structs.hpp"
...
class ABP_FactionOutpostVote_PirateLord_C : public AFactionOutpostVoteInteractionActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FactionOutpostVote_PirateLord.BP_FactionOutpostVote_PirateLord_C"));
		return ptr;
	}

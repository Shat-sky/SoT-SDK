...
public:
	...
	class UStaticMeshComponent*                        Glint;                                                    // 0x0A58(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPostProcessComponent*                       PostProcess;                                              // 0x0A60(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UMaterialInstanceDynamic*                    DynamicMaterial;                                          // 0x0A70(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	class UCurveFloat*                                 BlurCurve;                                                // 0x0A88(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UTexture2D*                                  LensNormal;                                               // 0x0A90(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  LensMask;                                                 // 0x0A98(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                LensTint;                                                 // 0x0AA0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

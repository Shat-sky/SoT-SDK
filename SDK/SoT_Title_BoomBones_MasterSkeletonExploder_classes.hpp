...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Title_BoomBones_MasterSkeletonExploder.Title_BoomBones_MasterSkeletonExploder_C"));
		return ptr;
	}

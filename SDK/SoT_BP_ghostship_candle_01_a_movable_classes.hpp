...
#include "SoT_BP_ghostship_candle_01_a_movable_structs.hpp"
...
// BlueprintGeneratedClass BP_ghostship_candle_01_a_movable.BP_ghostship_candle_01_a_movable_C
// 0x0070 (0x0438 - 0x03C8)
class ABP_ghostship_candle_01_a_movable_C : public AActor
{
public:
	...
	class UParticleSystemComponent*                    vfx_tavern_candle_looping_014;                            // 0x03E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    vfx_tavern_candle_looping_013;                            // 0x03E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    vfx_tavern_candle_looping_012;                            // 0x03F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    vfx_tavern_candle_looping_011;                            // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    vfx_tavern_candle_looping_01;                             // 0x0400(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ghostship_candle_01_a_movable.BP_ghostship_candle_01_a_movable_C"));
		return ptr;
	}

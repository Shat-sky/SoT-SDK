...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_CollectorsChest_RevengeOfTheMorningstar_Desc.BP_CollectorsChest_RevengeOfTheMorningstar_Desc_C");
		return ptr;
	}

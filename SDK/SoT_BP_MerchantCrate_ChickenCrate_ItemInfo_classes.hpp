...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_ChickenCrate_ItemInfo.BP_MerchantCrate_ChickenCrate_ItemInfo_C"));
		return ptr;
	}

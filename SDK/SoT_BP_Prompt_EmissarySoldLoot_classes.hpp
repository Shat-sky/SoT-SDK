...
#include "SoT_BP_Prompt_EmissarySoldLoot_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Prompt_EmissarySoldLoot.BP_Prompt_EmissarySoldLoot_C"));
		return ptr;
	}

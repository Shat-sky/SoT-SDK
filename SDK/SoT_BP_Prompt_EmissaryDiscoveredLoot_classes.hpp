...
#include "SoT_BP_Prompt_EmissaryDiscoveredLoot_structs.hpp"
...
public:
	...
	struct FName                                       CompnayName;                                              // 0x0168(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Prompt_EmissaryDiscoveredLoot.BP_Prompt_EmissaryDiscoveredLoot_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ResourceIslandWashedUpMessageInABottleSpawner.BP_ResourceIslandWashedUpMessageInABottleSpawner_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_HC_LegendaryHunterOfTheSeaOfThieves.Title_HC_LegendaryHunterOfTheSeaOfThieves_C");
		return ptr;
	}

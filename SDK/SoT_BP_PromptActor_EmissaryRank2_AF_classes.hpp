...
#include "SoT_BP_PromptActor_EmissaryRank2_AF_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_AF.BP_PromptActor_EmissaryRank2_AF_C"));
		return ptr;
	}

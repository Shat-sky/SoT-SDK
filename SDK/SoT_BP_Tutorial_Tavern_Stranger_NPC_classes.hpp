...
public:
	...
	class UCapsuleComponent*                           SolidHits;                                                // 0x07E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FText                                       MysteriousStranger;                                       // 0x0808(0x0038) (Edit, BlueprintVisible, DisableEditOnInstance)
	class ACutSceneActor*                              CutSceneActor;                                            // 0x0840(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)

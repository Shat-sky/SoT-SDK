...
{
public:
	class UConfigurableBuryableItemComponent*          ConfigurableBuryableItem;                                 // 0x0788(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTrackedOwnerComponent*                      TrackedOwner;                                             // 0x0790(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialManipulationComponent*              MaterialManipulation;                                     // 0x0798(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

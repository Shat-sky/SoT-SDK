...
{
public:
	class UConfigurableBuryableItemComponent*          ConfigurableBuryableItem;                                 // 0x07D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTrackedOwnerComponent*                      TrackedOwner;                                             // 0x07D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

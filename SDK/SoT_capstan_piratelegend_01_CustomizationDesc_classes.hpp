...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass capstan_piratelegend_01_CustomizationDesc.capstan_piratelegend_01_CustomizationDesc_C");
		return ptr;
	}

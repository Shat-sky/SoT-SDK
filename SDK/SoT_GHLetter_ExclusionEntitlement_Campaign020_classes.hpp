...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass GHLetter_ExclusionEntitlement_Campaign020.GHLetter_ExclusionEntitlement_Campaign020_C");
		return ptr;
	}

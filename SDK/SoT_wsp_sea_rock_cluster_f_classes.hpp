...
{
public:
	class UStaticMeshComponent*                        wsp_sea_rocks_a;                                          // 0x03C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        wsp_sea_rocks_b;                                          // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMeshComponent03;                                    // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        StaticMeshComponent0;                                     // 0x03F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
#include "SoT_BP_Prompt_RepairShipCapstan_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Prompt_RepairShipCapstan.BP_Prompt_RepairShipCapstan_C"));
		return ptr;
	}

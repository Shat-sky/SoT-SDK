...
#include "SoT_BP_VotableCancelVoyageSeaOfThievesOnDemand_structs.hpp"
...
class ABP_VotableCancelVoyageSeaOfThievesOnDemand_C : public AVotableObjectView
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_VotableCancelVoyageSeaOfThievesOnDemand.BP_VotableCancelVoyageSeaOfThievesOnDemand_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_VotableCancelVoyageSeaOfThievesOnDemand(int EntryPoint);
};

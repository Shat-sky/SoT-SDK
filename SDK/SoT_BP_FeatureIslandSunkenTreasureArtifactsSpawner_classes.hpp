...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FeatureIslandSunkenTreasureArtifactsSpawner.BP_FeatureIslandSunkenTreasureArtifactsSpawner_C"));
		return ptr;
	}

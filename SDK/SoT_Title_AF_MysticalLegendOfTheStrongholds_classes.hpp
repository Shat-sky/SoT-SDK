...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Title_AF_MysticalLegendOfTheStrongholds.Title_AF_MysticalLegendOfTheStrongholds_C"));
		return ptr;
	}

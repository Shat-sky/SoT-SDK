...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass flag_Alliance_Join_01_CustomizationDesc.flag_Alliance_Join_01_CustomizationDesc_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass figurehead_reapersbones_b_01_CustomizationDesc.figurehead_reapersbones_b_01_CustomizationDesc_C"));
		return ptr;
	}

...
// Function BP_Mast.BP_Mast_C.SetupMastMesh
// (Public, BlueprintCallable, BlueprintEvent)

void ABP_Mast_C::SetupMastMesh()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_Mast.BP_Mast_C.SetupMastMesh"));

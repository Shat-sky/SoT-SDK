...
public:
	...
	class UInstancedStaticMeshComponent*               InstancedStaticMesh;                                      // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FPointLightProxy>                    LightList;                                                // 0x03E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)

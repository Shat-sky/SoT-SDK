...
public:
	...
	class UStaticMeshComponent*                        cap_cage_door_03_a;                                       // 0x0620(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UInteractableComponent*                      Interactable;                                             // 0x0628(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

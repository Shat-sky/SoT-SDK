...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Proposal_RevengeOfTheMornignstar_Chapter3.Proposal_RevengeOfTheMornignstar_Chapter3_C");
		return ptr;
	}

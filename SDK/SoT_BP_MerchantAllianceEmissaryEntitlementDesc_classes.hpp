...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MerchantAllianceEmissaryEntitlementDesc.BP_MerchantAllianceEmissaryEntitlementDesc_C");
		return ptr;
	}

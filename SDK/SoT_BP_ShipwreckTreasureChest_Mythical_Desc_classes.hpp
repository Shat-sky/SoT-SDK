...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ShipwreckTreasureChest_Mythical_Desc.BP_ShipwreckTreasureChest_Mythical_Desc_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass sailslivery_creator_01_CustomizationDesc.sailslivery_creator_01_CustomizationDesc_C"));
		return ptr;
	}

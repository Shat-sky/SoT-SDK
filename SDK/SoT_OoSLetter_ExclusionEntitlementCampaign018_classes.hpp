...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass OoSLetter_ExclusionEntitlementCampaign018.OoSLetter_ExclusionEntitlementCampaign018_C");
		return ptr;
	}

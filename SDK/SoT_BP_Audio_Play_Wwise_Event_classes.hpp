...
public:
	...
	class UWwiseEmitterComponent*                      BPAudioEvent;                                             // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UWwiseEvent*>                         WwiseEvent;                                               // 0x03D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)

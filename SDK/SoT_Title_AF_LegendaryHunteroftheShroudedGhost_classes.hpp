...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_AF_LegendaryHunteroftheShroudedGhost.Title_AF_LegendaryHunteroftheShroudedGhost_C");
		return ptr;
	}

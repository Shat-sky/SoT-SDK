...
{
public:
	class UStaticMeshComponent*                        shp_rope_coil_02_a;                                       // 0x0408(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_sail_controls_cleat_01_a_vertical;                    // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
public:
	...
	TArray<struct FInstance_Struct>                    Instances;                                                // 0x0418(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              DrawDistance;                                             // 0x0428(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

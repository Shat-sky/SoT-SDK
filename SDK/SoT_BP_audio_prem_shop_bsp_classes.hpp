...
#include "SoT_BP_audio_prem_shop_bsp_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_audio_prem_shop_bsp.BP_audio_prem_shop_bsp_C"));
		return ptr;
	}

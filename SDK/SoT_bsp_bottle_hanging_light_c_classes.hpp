...
#include "SoT_bsp_bottle_hanging_light_c_structs.hpp"
...
class Absp_bottle_hanging_light_c_C : public AStaticMeshActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass bsp_bottle_hanging_light_c.bsp_bottle_hanging_light_c_C"));
		return ptr;
	}

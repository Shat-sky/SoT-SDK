...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Lantern_LargeShip_BrigDeck_InsideBrig.BP_Lantern_LargeShip_BrigDeck_InsideBrig_C"));
		return ptr;
	}

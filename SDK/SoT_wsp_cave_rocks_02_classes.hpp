...
{
public:
	class UStaticMeshComponent*                        StaticMeshComponent06;                                    // 0x0408(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass wsp_cave_rocks_02.wsp_cave_rocks_02_C"));
		return ptr;
	}

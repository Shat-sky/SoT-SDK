...
#include "SoT_BP_PromptActor_CosmeticPurchased_Weapon_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_CosmeticPurchased_Weapon.BP_PromptActor_CosmeticPurchased_Weapon_C"));
		return ptr;
	}

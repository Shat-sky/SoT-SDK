...
#include "SoT_BP_PromptActor_EmissaryRank2_GH_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_GH.BP_PromptActor_EmissaryRank2_GH_C"));
		return ptr;
	}

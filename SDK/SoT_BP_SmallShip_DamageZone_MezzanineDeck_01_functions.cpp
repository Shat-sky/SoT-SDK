...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallShip_DamageZone_MezzanineDeck_01.BP_SmallShip_DamageZone_MezzanineDeck_01_C.UserConstructionScript"));

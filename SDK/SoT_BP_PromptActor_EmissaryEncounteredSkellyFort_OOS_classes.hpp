...
#include "SoT_BP_PromptActor_EmissaryEncounteredSkellyFort_OOS_structs.hpp"
...
public:
	...
	class UBP_Prompt_EmissaryEncounteredSkellyFort_C*  PromptCoordinator;                                        // 0x0450(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_EmissaryEncounteredSkellyFort_OOS.BP_PromptActor_EmissaryEncounteredSkellyFort_OOS_C"));
		return ptr;
	}

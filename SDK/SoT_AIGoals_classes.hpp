...
public:
	...
	struct FBestActionSpotSelectionCriteria            BestActionSpotSelectionCriteria;                          // 0x00C0(0x0024) (Edit)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x00E4(0x001C) MISSED OFFSET
...
public:
	...
	TArray<TEnumAsByte<EMovementMode>>                 IgnoredMovementModes;                                     // 0x0040(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	bool                                               ShouldOnlyActivateWhileDocked;                            // 0x0050(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0051(0x0007) MISSED OFFSET
	class APawn*                                       TargetPlayerPawn;                                         // 0x0058(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<TEnumAsByte<EMovementMode>>                 IgnoredMovementModes;                                     // 0x0040(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	class UClass*                                      WhileActiveActivityType;                                  // 0x0050(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class APawn*                                       TargetPlayerPawn;                                         // 0x0058(0x0008) (ZeroConstructor, Transient, IsPlainOldData)

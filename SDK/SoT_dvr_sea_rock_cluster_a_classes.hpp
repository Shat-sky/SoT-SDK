...
#include "SoT_dvr_sea_rock_cluster_a_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass dvr_sea_rock_cluster_a.dvr_sea_rock_cluster_a_C"));
		return ptr;
	}

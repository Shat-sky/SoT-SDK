...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_RailingLight_SmallShip_BowLeftFront.BP_RailingLight_SmallShip_BowLeftFront_C"));
		return ptr;
	}

...
// Function BP_VotableCancelTale.BP_VotableCancelTale_C.GetVoteCount
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            Count                          (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABP_VotableCancelTale_C::GetVoteCount(int* Count)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_VotableCancelTale.BP_VotableCancelTale_C.GetVoteCount"));

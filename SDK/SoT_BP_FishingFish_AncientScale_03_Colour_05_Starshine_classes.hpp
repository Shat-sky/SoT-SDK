...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FishingFish_AncientScale_03_Colour_05_Starshine.BP_FishingFish_AncientScale_03_Colour_05_Starshine_C"));
		return ptr;
	}

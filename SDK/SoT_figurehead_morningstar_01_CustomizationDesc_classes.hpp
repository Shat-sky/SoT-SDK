...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass figurehead_morningstar_01_CustomizationDesc.figurehead_morningstar_01_CustomizationDesc_C"));
		return ptr;
	}

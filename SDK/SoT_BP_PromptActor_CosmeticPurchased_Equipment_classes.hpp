...
#include "SoT_BP_PromptActor_CosmeticPurchased_Equipment_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_CosmeticPurchased_Equipment.BP_PromptActor_CosmeticPurchased_Equipment_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TreasureChest_PirateLegend_Desc_DVR.BP_TreasureChest_PirateLegend_Desc_DVR_C"));
		return ptr;
	}

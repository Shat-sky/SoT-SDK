...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_ForsakenShores_LegendaryCargoRunner.Title_ForsakenShores_LegendaryCargoRunner_C");
		return ptr;
	}

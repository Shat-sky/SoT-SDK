...
#include "SoT_BP_PromptActor_EmissaryRank2_OOS_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromptActor_EmissaryRank2_OOS.BP_PromptActor_EmissaryRank2_OOS_C"));
		return ptr;
	}

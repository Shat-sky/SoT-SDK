...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass AD_ThirdPerson_PlayerPirate_Male_Large.AD_ThirdPerson_PlayerPirate_Male_Large_C"));
		return ptr;
	}

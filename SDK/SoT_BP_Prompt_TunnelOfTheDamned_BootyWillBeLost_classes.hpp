...
public:
	...
	class UTunnelsOfTheDamnedLootFilterDataAsset*      LootFilterDataAsset;                                      // 0x01E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

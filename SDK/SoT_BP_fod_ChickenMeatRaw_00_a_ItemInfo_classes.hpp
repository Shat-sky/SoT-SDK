...
#include "SoT_BP_fod_ChickenMeatRaw_00_a_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_fod_ChickenMeatRaw_00_a_ItemInfo.BP_fod_ChickenMeatRaw_00_a_ItemInfo_C"));
		return ptr;
	}

...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Title_FestivalofTheDamned_SailorOfTheDamned.Title_FestivalofTheDamned_SailorOfTheDamned_C");
		return ptr;
	}

...
// Function AthenaAI.AICreatureSpline.OnRep_ShouldTickBeEnabled
// (Final, Native, Private)

void AAICreatureSpline::OnRep_ShouldTickBeEnabled()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.AICreatureSpline.OnRep_ShouldTickBeEnabled"));
...
// Function AthenaAI.AICreatureSpline.OnCreatureMovementStarted
// (Event, Protected, BlueprintEvent)

void AAICreatureSpline::OnCreatureMovementStarted()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.AICreatureSpline.OnCreatureMovementStarted"));
...
// Function AthenaAI.AICreatureSpline.OnCreatureMovementCompleted
// (Event, Protected, BlueprintEvent)

void AAICreatureSpline::OnCreatureMovementCompleted()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.AICreatureSpline.OnCreatureMovementCompleted"));
...
// Function AthenaAI.AICreatureSpline.BeginCreatureMovement
// (Final, Native, Protected, BlueprintCallable)

void AAICreatureSpline::BeginCreatureMovement()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.AICreatureSpline.BeginCreatureMovement"));
...
// Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionStartedClient
// (Event, Protected, BlueprintEvent)

void ALimitedInteractableAICreatureSpline::OnInteractionStartedClient()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionStartedClient"));
...
// Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedServer
// (Event, Protected, BlueprintEvent)
// Parameters:
// class AActor*                  PlayerCharacter                (Parm, ZeroConstructor, IsPlainOldData)

void ALimitedInteractableAICreatureSpline::OnInteractionCompletedServer(class AActor* PlayerCharacter)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedServer"));
...
// Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedClient
// (Event, Protected, BlueprintEvent)

void ALimitedInteractableAICreatureSpline::OnInteractionCompletedClient()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedClient"));
...
// Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCancelledClient
// (Event, Protected, BlueprintEvent)

void ALimitedInteractableAICreatureSpline::OnInteractionCancelledClient()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCancelledClient"));
...
// Function AthenaAI.LimitedInteractableAICreatureSpline.InteractCountRetrieved
// (Final, Native, Protected, BlueprintCallable)
// Parameters:
// int                            InInteractedCount              (ConstParm, Parm, ZeroConstructor, IsPlainOldData)

void ALimitedInteractableAICreatureSpline::InteractCountRetrieved(int InInteractedCount)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.LimitedInteractableAICreatureSpline.InteractCountRetrieved"));

	struct
	{
		int                            InInteractedCount;
	} params;

	params.InInteractedCount = InInteractedCount;
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.AIDebugSpawnActor.StartSpawning"));
...
// TArray<struct FAIEncounterSpecification> ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

TArray<struct FAIEncounterSpecification> UAthenaAIDebugFunctionLibrary::SpawnMultipleAI(int Count, class UAIEncounterSettings* EncounterSettings, const struct FVector& Pos, const struct FRotator& Rot, float Delay, bool MakeAIPermanentlyNetRelevant, class AActor* InstancedNavMesh)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnMultipleAI"));
	...
	struct
	{
		...
		TArray<struct FAIEncounterSpecification> ReturnValue;
	} params;
...
// Function AthenaAI.Pet.OnRep_PetInfo
// (Final, Native, Private)

void APet::OnRep_PetInfo()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AthenaAI.Pet.OnRep_PetInfo"));

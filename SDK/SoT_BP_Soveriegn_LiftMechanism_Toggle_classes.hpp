...
public:
	...
	class UStaticMeshComponent*                        StaticMesh4;                                              // 0x0580(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBP_RopeRendererComponent_C*                 BP_RopeRendererComponent;                                 // 0x0588(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             Rope_Source;                                              // 0x0590(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UIntentCombinerComponent*                    IntentCombiner;                                           // 0x0598(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

...
#include "SoT_BP_FishedItem_Wieldable_Base_structs.hpp"
...
class ABP_FishedItem_Wieldable_Base_C : public AStaticSimpleBootyWieldableItem
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FishedItem_Wieldable_Base.BP_FishedItem_Wieldable_Base_C"));
		return ptr;
	}

...
#include "SoT_BP_TaleBook_LegendaryStoryteller_AdditionalPuzzles_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TaleBook_LegendaryStoryteller_AdditionalPuzzles.BP_TaleBook_LegendaryStoryteller_AdditionalPuzzles_C"));
		return ptr;
	}

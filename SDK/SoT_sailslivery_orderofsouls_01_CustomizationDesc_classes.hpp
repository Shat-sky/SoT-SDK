...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass sailslivery_orderofsouls_01_CustomizationDesc.sailslivery_orderofsouls_01_CustomizationDesc_C");
		return ptr;
	}

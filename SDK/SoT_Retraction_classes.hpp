...
public:
	...
	struct FName                                       FeatureToggle;                                            // 0x0100(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FRetractorOrientationAdjustmentFlags        OrientationAdjustmentOnRetractFlags;                      // 0x0108(0x0003) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EAxis>                                 RetractorBoxAxis;                                         // 0x010B(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               ShouldAutoReleaseOnSuccessfulRetract;                     // 0x010C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               MigrateAttachedWithRetractor;                             // 0x010D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               WasSimulatingPhysicsBeforeRetract;                        // 0x010E(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TScriptInterface<class UBuoyancyInterface>         OwnerBuoyancyInterface;                                   // 0x0110(0x0010) (ZeroConstructor, Transient, IsPlainOldData)
